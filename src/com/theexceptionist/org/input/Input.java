package com.theexceptionist.org.input;
...
import com.theexceptionist.org.GameMain;
...
public class Input implements KeyListener {
	...
	private void toggle(KeyEvent ke, boolean pressed) {
		...
		if (ke.getKeyCode() == KeyEvent.VK_CONTROL) select.toggle(pressed);
		if (ke.getKeyCode() == KeyEvent.VK_NUMPAD0) select.toggle(pressed);
		if (ke.getKeyCode() == KeyEvent.VK_INSERT) select.toggle(pressed);
		if (ke.getKeyCode() == KeyEvent.VK_ENTER) menu.toggle(pressed);

		if (ke.getKeyCode() == KeyEvent.VK_X) menu.toggle(pressed);
		if (ke.getKeyCode() == KeyEvent.VK_C) select.toggle(pressed);
	}
